...
public class DeserializationContext {
	...
	public void putToCache(Object id, DBObject fields, Object value) {
		cache.put(new CacheKey(value.getClass(), id, fields), value);
	}

	public boolean isCached(Class<?> clazz, Object id, DBObject fields) {
		return cache.containsKey(new CacheKey(clazz, id, fields));
	}

	public Object getCached(Class<?> clazz, Object id, DBObject fields) {
		return cache.get(new CacheKey(clazz, id, fields));
	}
	...
	public static class CacheKey {
		...
		public CacheKey(Class<?> clazz, Object id, DBObject fields) {
			this.clazz = clazz;
			this.id = id;
			this.fields = fields;
		}
